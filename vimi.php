			...
			<div class="row">
				<div class="col text-center">
					<div class="inner-column">
						<h1>Visi</span></h1>		
						<p>"MENJADI KOTA MASA DEPAN YANG MULTIKULTURAL, BERDAYA SAING,HUMANIS, SEJAHTERA DAN RELIGIUS" </p>
					</div>
				</div>
            </div>
            <div class="row">
				<div class="col text-center">
					<div class="inner-column">
						<h1>Misi</span></h1>
						<p>"MEWUJUDKAN TATA RUANG KOTA YANG KONSISTEN SERTA DIDUKUNG KETERSEDIAAN INSFRASTRUKTUR DAN UTILITAS KOTA YANG SEMAKIN MODERN SERTA BERKELANJUTAN" </p>
					</div>
				</div>
			</div>
		</div>
