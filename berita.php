	...
	<div class="col-rt-12">
		<div class="row">
			<div class="col-lg-12">
				...
				<!-- Artikel 1 -->
				<div style="width: 355px;margin-left: 45px;border-color: green;font-family: 'Athiti', sans-serif;" class="card">
				...
				<!-- Artikel 2 -->
				<div style="width: 355px;margin-left: 65px;border-color: green;font-family: 'Athiti', sans-serif;" class="card">
					<img style="width: 343px;height: 190px;border-radius: 10px;" src="images/BKN.jpg"><br>
						...
						<p style="text-align: left;" >Post by : Admin <br> [30/02/2020]</p>
				...
				<!-- Artikel 4 -->
				<div style="width: 355px;margin-left: 45px;margin-top: 50px;border-color: green;font-family: 'Athiti', sans-serif;" class="card">
					<img style="width: 343px;height: 190px;border-radius: 10px;" src="images/bkn.jpg"><br>
						<h3 style="text-align: justify;" >Artikel</h3>
						<p style="text-align: justify;" >Artikel </p>
						<p style="text-align: left;" >Post by : Admin <br> [30/02/2020]</p>
				...
				<!-- Artikel 5 -->
				<div style="width: 355px;margin-left: 65px;margin-top: 50px;border-color: green;font-family: 'Athiti', sans-serif;" class="card">
					<img style="width: 343px;height: 190px;border-radius: 10px;" src="images/bkn.jpg"><br>
						<h3 style="text-align: justify;" >Artikel</h3>
						<p style="text-align: justify;" >artikel</p>
						<p style="text-align: left;" >Post by : Admin <br> [30/02/2020]</p>
