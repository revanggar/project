	...
	<div id="slides" class="cover-slides">
		<ul class="slides-container">
			<li class="text-center">
				<img src="images/dlh1.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20" style="font-family: 'Athiti', sans-serif;"><strong>Selamat Datang Di<br> Dinas Lingkungan Hidup Kota Medan</strong></h1>
						</div>
					</div>
				</div>
			<li class="text-center">
				<img style="padding-top: 25px;" src="images/pemko_medan.jpg" alt="">
				<div class="container">
				</div>
			</li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column" style="font-family: 'Athiti', sans-serif;">
